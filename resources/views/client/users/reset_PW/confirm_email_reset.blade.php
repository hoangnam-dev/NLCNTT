...
<form action="{{ route('client.user.confirm-email') }}" method="POST">
    ...
    <h3 class="text-center text-dark mb-4 title-font">Xác nhận Email</h3>
    <div class="form-icon">
        <span><i class="icon icon-user"></i></span>
    </div>
    <div class="form-group">
        <p>Bạn hãy nhập vào <strong>Email</strong> đã đăng ký tài khoản. Chúng tôi sẽ gửi mã xác nhận đến email đó.</p>
    </div>
    @if (session('status'))
