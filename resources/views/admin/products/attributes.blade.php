...
<div class="mb-3">
    ...
    <div class="input-group">
      ...
      <button type="button" class="btn btn-info add_attr_modal mb-3" data-toggle="modal" data-target="#exampleModal" data-attr_id="{{ $attribute->matt }}" data-whatever="@getbootstrap">Thêm giá trị</button>
    </div>
  </div>
</div>
@endforeach