    ...
    <div class="form-floating mb-3">
      ...
      <div class="d-flex justify-content-start justify-content-lg-start align-items-center">
        <div class="form-check form-switch mr-4">
          <input class="form-check-input" name="customer_gender" value="Nam" type="checkbox" role="switch" {{ $customer->GioiTinh=='Nam'?'checked':'' }}>
          <label class="form-check-label-label" for="flexSwitchCheckDefault">Nam</label>
        </div>
        <div class="form-check form-switch mr-4">
          <input class="form-check-input" name="customer_gender" value="Nữ" type="checkbox" role="switch" {{ $customer->GioiTinh=='Nữ'?'checked':'' }}>
          <label class="form-check-label-label" checked for="flexSwitchCheckDefault">Nữ</label>
        </div>
        <div class="form-check form-switch mr-4">
          <input class="form-check-input" name="customer_gender" value="Khác" type="checkbox" role="switch" {{ $customer->GioiTinh=='Khác'?'checked':'' }}>
