...
class UserController extends Controller
{
    ...
    public function handleResetPasswordForm(Request $request) {
        ...
        if($customer === null) {
            ...
            $confirm_email = true;
            // return redirect()->back()->with('title', $title)->with('confirm_email', $confirm_email)->with('customer', $customer);
            return redirect()->back()->with('status', 'success')->with('message', 'OK')->with('customer', $customer);
        }
    }
