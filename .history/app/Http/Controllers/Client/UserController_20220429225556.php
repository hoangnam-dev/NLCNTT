...
class UserController extends Controller
{
    ...
    public function handleEmailReset(Request $request) {
        ...
        if($customer === null) {
            ...
            return redirect()->route('client.user.reset-password', compact('title'))->with('confirm_email', $confirm_email)->with('customer', $customer);
        }
    }
    public function verificationCode(Request $request) {
        $this->data['title'] = 'Nhập mã xác nhận';
        $confirm_email = true;
        return view('client.users.reset_PW.verification_code', $this->data)->with('confirm_email', $confirm_email);
    }
    public function handelVerificationCode(Request $request) {
        ...
        if($customer->resetpass_token === $request->verification_code) {
           return redirect()->route('client.user.reset-password-form');
        } 
        else {
