...
class ProductsController extends Controller
{
    ...
    public function index()
    {
        ...
        $this->data['listProducts'] = Products::orderBy('create_at', 'DESC')->with('hasPromotion')->with('hasCategory')->search()->paginate($this->paginateNumber);
    ...
    public function store(Request $request)
    {
        ...
        if (isset($request->giatri_tt)) {
            foreach ($request->giatri_tt as $key => $value) {
                if($value!='null') {
                    $productDetailModel = ProductDetail::insert([
                        'masp' => $lastID,
                        'matt' => $request->matt[$key],
                        'giatritt' => $value,
                    ]);
                }
            }
    ...
    public function edit(Request $request)
    {
        ...
        // $this->data['product'] = Products::join('chitietsp','chitietsp.masp','=','sanpham.masp')
