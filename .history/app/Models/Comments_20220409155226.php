...
class Comments extends Model
{
    ...
    protected $table = 'danhgia'; // nếu tên models trùng với tên table thì có thể không khai báo
    ...
    public function hasReplyComment()
    {
        return $this->belongsTo('App\Models\Comments', 'mabl', 'parent_id');
    }
