...
class Products extends Model
{
    ...
    public function hasImages(){
        return $this->hasMany('App\Models\ProductImages', 'masp', 'masp');
    }

    // Relationship with ProductDetail
    public function hasProductDetail(){
        return $this->hasMany('App\Models\ProductDetail', 'masp', 'masp');
    }

     // Relationship with Order (Many to Many)
    public function orders()
    {
        return $this->belongsToMany('App\Models\Orders','chitietdonhang','masp','madh');
    }
