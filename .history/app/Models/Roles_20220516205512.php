...
class Roles extends Model
{
    ...
    protected $table = 'quyen'; // nếu tên models trùng với tên table thì có thể không khai báo
    ...
    {
        return $this->belongsToMany('App\Models\Admin', 'chitietquyen', 'maquyen', 'manv');
    }
