...
// });
Route::post('/dang-nhap', [UserLoginController::class, 'handleLogin'])->name('dang-nhap');
Route::post('/dang-ky', [CustomersController::class, 'store'])->name('dang-ky');
Route::get('/dang-xuat', [UserLoginController::class, 'logout'])->name('dang-xuat');
