...
Route::prefix('/categories')->group(function () {
    Route::get('/',[CategoryController::class, 'index'])->name('client.catergory');
    Route::get('/{danh_muc}',[CategoryController::class, 'listProductsByCategory'])->name('client.productsbycatergory');
...
Route::middleware('checkuserlogin')->prefix('/check-out')->group(function() {
    ...
    Route::post('/', [CheckOutController::class, 'payment']);
    Route::post('/order', [CheckOutController::class, 'store'])->name('client.checkout.default-pay');
