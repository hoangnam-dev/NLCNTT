...
Route::prefix('/user')->group(function() {
    ...
    Route::get('/reset-password', [UserController::class, 'confirmEmailReset'])->name('client.user.reset-password');
    Route::post('/reset-password', [UserController::class, 'handleResetPasswordForm']);
    Route::get('/change-password', [UserController::class, 'resetPasswordFrom'])->name('client.user.reset-password-form');
    Route::post('/change-password', [UserController::class, 'handleResetPassword']);
