...
Route::prefix('/user')->group(function() {
    ...
    Route::post('/confirm-email', [UserController::class, 'handleResetPasswordForm']);
    Route::get('/confirm-verification', [UserController::class, 'confirmEmailReset'])->name('client.user.confirm-email');
    Route::post('/confirm-verification', [UserController::class, 'handleResetPasswordForm']);
