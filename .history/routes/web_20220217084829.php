...
Route::prefix('/user')->group(function() {
    Route::get('/login', [UserLoginController::class, 'formLogin'])->name('user.login');
    Route::post('/login', [UserLoginController::class, 'handleLogin']);
    Route::get('/register', [UserLoginController::class, 'formRegister'])->name('user.register');
