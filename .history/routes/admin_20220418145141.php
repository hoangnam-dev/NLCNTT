...
Route::prefix('/admin')->group(function () {
    ...
    Route::middleware('checklogin')->group(function () {
        ...
        Route::prefix('/products')->group(function () {
            ...
            // Route::put('/trang thai-san-pham', [ProductsController::class, 'status'])->name('admin.products.product-delete');
            Route::get('/sua-trang-thai-sp', [ProductsController::class, 'status'])->name('admin.products.product-status');
        ...
        Route::prefix('/categories')->group(function () {
            ...
            Route::put('/sua-trang-thai-dm', [CategoryController::class, 'status'])->name('admin.categories.category-status');
