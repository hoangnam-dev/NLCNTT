...
Route::prefix('/admin')->group(function () {
    ...
    Route::middleware('checkadminlogin')->group(function () {
        ...
        Route::put('/them-quyen', [AdminController::class, 'setRole'])->name('admin.users.admin-set-role');
        ...
        Route::prefix('/roles')->group(function () {
            ...
            Route::put('/sua-quyen', [RolesController::class, 'setRole']);
            Route::post('/sua-quyen', [RolesController::class, 'getRole']);
