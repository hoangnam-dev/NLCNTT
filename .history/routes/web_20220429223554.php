...
Route::prefix('/user')->group(function() {
    ...
    Route::post('/change-password', [UserController::class, 'resetPasswordFrom'])->name('client.user.reset-password-form');
    Route::put('/change-password', [UserController::class, 'handleResetPassword']);
