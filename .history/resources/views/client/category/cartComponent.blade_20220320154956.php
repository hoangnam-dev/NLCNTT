...
<div class="mt-5 border border-light shadow-sm p-3 mb-5 bg-white rounded">
    ...
    <table class="table cartData" data-url="{{ route('client.cart.updateCart') }}">
        ...
        <tbody class="cart-body">
            ...
            <tr class="cart_item">
                ...
                <td class="cart_price">
                    <span class="text-danger">{{ number_format($item['product_price'],'0',',','.') }} VNĐ</span>
                </td>
                ...
                <td class="cart_subtotal">
                    <span class="cart_subtotal_price">{{ number_format($item['subtotal'],'0',',','.') }} VNĐ</span>
                </td>
    ...
    <div class="col-md-12 mt-3 cart-bottom d-flex justify-content-md-between align-items-center">
        ...
        <div class="cart-total">Tổng cộng: <span class="me-5 mx-4">{{ number_format($total,'0',',','.') }} VNĐ</span></div>
    </div>
    @else
