    ...
    <div class="container text-center text-md-start pt-5">
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
          ...
          <p>
            <a href="{{ route('client.news') }} }}" class="text-reset text-decoration-none">Tin tức</a>
          </p>
          <p>
            <a href="{{ route('client.policy') }}" class="text-reset text-decoration-none">Chính sách bảo mật</a>
          </p>
        </div>
        <!-- Grid column -->
