                      ...
                      <form id="form-login" class="form" method="POST" role="form">
                        <div class="form-container">
                          <div class="form_header">
                            ...
                            <a id="popupRegisterForm" class="form_switch-btn" data-bs-target="#registerModal" data-bs-toggle="modal">Đăng Ký</a>
                          </div>
                        ...
                        <form id="form-register" class="form" method="POST" id="form-register">
                          <div class="form-container">
                            <div class="form_header">
                              ...
                              <a id="popupLoginForm" class="form_switch-btn" data-bs-target="#loginModal" data-bs-toggle="modal">Đăng Nhập</a>
                            </div>
                            <div class="form_group">
