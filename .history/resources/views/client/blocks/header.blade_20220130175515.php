                  ...
                  <div class="modal-body">
                      <form class="mb-3" method="POST">
                        ...
                        <div class="form-group mb-3">
                          ...
                          @if (session('passErr'))
                          <small id="emailHelp" class="form-text text-danger">{{ session('passErr') }}</small>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body mx-3">
                      <div class="md-form mb-5">
                        <i class="fas fa-phone-alt f-icon f-icon"></i>
                        <input type="email" id="defaultForm-email" class="form-control validate" placeholder="Số Điện thoại">
                      </div>
              
                      <div class="md-form mb-4">
                        <i class="fas fa-lock prefix grey-text f-icon"></i>
                        <input type="password" id="defaultForm-pass" class="form-control validate" placeholder="Mật Khẩu">
                      </div>
