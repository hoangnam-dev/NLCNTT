                      ...
                      <form id="form-login" class="form" method="POST" role="form">
                        <div class="form-container">
                          <div class="form_header">
                            ...
                            <button id="popupRegisterForm" class="btn btn-primary form_switch-btn" data-bs-target="#registerModal" data-bs-toggle="modal">Đăng Ký</button>
                          </div>
                        ...
                        <form id="form-register" class="form" method="POST" id="form-register">
                          <div class="form-container">
                            <div class="form_header">
                              ...
                              <button id="popupLoginForm" class="btn btn-primary form_switch-btn" data-bs-target="#loginModal" data-bs-toggle="modal">Đăng Nhập</button>
                            </div>
                            <div class="form_group">
