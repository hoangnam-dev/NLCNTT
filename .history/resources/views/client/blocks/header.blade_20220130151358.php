        ...
        <ul class="header_navbar-list">
          ...
          <li class="header_navbar-item">
            <a id="popupRegister" class="btn-modal header_navbar-item-link header_navbar-item-strong"
              data-bs-toggle="modal" data-bs-target="#m2">Đăng ký</a>
          </li>
          ...
          <!-- Modal -->
          <div class="modal fade" id="m2" tabindex="-1" aria-labelledby="m2" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="m2t">Modal title</h5>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                  <div class="form-general">
