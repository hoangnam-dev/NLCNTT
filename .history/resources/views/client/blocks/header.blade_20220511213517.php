  ...
  <div class="container">
    <div class="header-top_nav">
      ...
      <ul class="header_navbar-list">
        <!-- Has Login -->
        @if (Auth::check())
        <input type="hidden" class="check-login" value="1">
        ...
        @else
        <input type="hidden" class="check-login" value="0">
        <!-- Hasn't Login -->
...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #cdc438;">
  <div class="container">
    <a class="navbar-brand title-font" href="{{ route('client.home') }}">
    ...
    <div class="collapse navbar-collapse me-5" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          {{-- <a class="nav-link active title-font category-link" aria-current="page" href="{{ route('client.home') }}">Trang chủ</a> --}}
          <a class="nav-link title-font category-link" aria-current="page" href="{{ route('client.home') }}">Trang chủ</a>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link title-font category-link" href="{{ route('client.category') }}" id="navbarDropdown">
            Danh mục
          </a>
        ...
        <li class="nav-item">
          <a class="nav-link title-font category-link" href="{{ route('client.news') }}">Tin tức</a>
        </li>
        <li class="nav-item">
          <a class="nav-link title-font category-link" href="{{ route('client.policy') }}">Chính sách bảo mật</a>
        </li>
        {{-- <li class="nav-item">
