...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #cdc438;">
  <div class="container">
    <a class="navbar-brand" href="{{ route('client.home') }}">
      <img class="navbar-logo title-font" src="{{ asset('assets/uploads/web_logo.png') }}" alt="">
      ABCShop
    </a>
    ...
    <div class="collapse navbar-collapse me-5" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active title-font" aria-current="page" href="{{ route('client.home') }}">Trang chủ</a>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link title-font" href="{{ route('client.category') }}" id="navbarDropdown">
            Danh mục
          </a>
        ...
        <li class="nav-item">
          <a class="nav-link title-font" href="{{ route('client.news') }}">Tin tức</a>
        </li>
        <li class="nav-item">
          <a class="nav-link title-font" href="{{ route('client.policy') }}">Chính sách bảo mật</a>
        </li>
        {{-- <li class="nav-item">
