                ...
                <div class="modal-content">
                  <div class="modal-header">
                   <h3 class="form_heading">Đăng Nhập</h3>
                    <button type="button" id="popupRegisterForm" class="button button_general form_switch-btn" data-bs-target="#registerModal" data-bs-toggle="modal">Đăng Ký</button>
                  </div>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <button type="button" id="popupLoginForm" class="button button_general form_switch-btn" data-bs-target="#loginModal"
                        data-bs-toggle="modal">Đăng Nhập</button>
                    </div>
                    <div class="modal-body">
                      <div class="form-general">
