                  ...
                  <div class="modal-body">
                      <form class="mb-3" action="{{ route('dang-nhap') }}" method="POST">
                        ...
                        <div class="form-group mb-3">
                          ...
                          @if (session('emailErr'))
                          <small id="emailError" class="form-text text-danger">{{ session('emailErr') }}</small>
                          @endif
                        </div>
                        <div class="form-group mb-3">
                          <input type="password" class="form-control" name="user_password" id="exampleInputPassword1" placeholder="Password">
                          @if (session('passErr'))
                          <small id="passwordError" class="form-text text-danger">{{ session('passErr') }}</small>
                          @endif
                        </div>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body mx-3">
                      <form id="form-register" method="POST">
                        ...
                        <div class="form-group mb-3">
                          <input type="text" id="rg_phone" class="form-control" name="user_phone"
                        ...
                        <div class="form-group mb-3">
                          <input type="text" id="rg_username" class="form-control" name="user_name"
                        ...
                        <div class="form-group mb-3">
                          <input type="text" id="rg_address" class="form-control" name="user_address"
                            placeholder="Địa chỉ" />
                        ...
                        <div class="form-group mb-3">
                          <input type="password" id="rg_password" class="form-control" name="user_password"
                        ...
                        <div class="form-group mb-3">
                          <input type="password" class="form-control" name="user_repassword" id="rg_repassword"
