...
<div class="container mb-5">
        ...
        <div class="col-md-7 col-sm-12 rounded" style="margin-top: 10px;">
            <div class="description">
                ...
                <div class="description-overlay">
                    ...
                    <button type="button" class="toggle_btn btn btn-outline-dark" data-bs-toggle="modal" data-bs-target="#ModalDescription">
                        Xem thêm
                      </button>
                </div>
    ...
    @include('client.products.product_description')
    ...
    <div class="col-lg-12 mt-5 product-comment">
        <div class="card">
            ...
            @else
            <div class="alert alert-info text-center">Bạn đã đánh giá sản phẩm này!</div>
            @endif
            <hr class="mt-3 mb-3">
            <div class="card-body">
