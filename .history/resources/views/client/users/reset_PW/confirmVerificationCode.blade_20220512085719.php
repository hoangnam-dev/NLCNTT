...
<form action="{{ route('client.user.confirm-verification') }}" method="POST">
    ...
    <div class="resend">Không nhận được mã? <span class="resend-link text-danger font-weight-bold" data-url="{{ route('client.user.resend-verify-code') }}" data-token="{{ csrf_token() }}">Gửi lại</span><div class="message mb-2"></div></div>
