...
<form action="{{ route('client.user.reset-password') }}" method="post">
    ...
    <div class="form-group">
        <input type="password" name="customer_email" class="form-control item" value="{{ old('customer_email') }}"
            placeholder="Email">
    ...
    <div class="form-group">
        <a href="{{ route('client.user.login') }}" class="btn btn-block btnBack">Trở lại</a>
    </div>
</form>
@else
