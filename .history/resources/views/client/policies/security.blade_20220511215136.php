        ...
        <div class="row">
            <div class="col-md-12">
                <div class="policy-content mt-2">
                    <h2 class="title-font mt-2">Bình luận</h2>
                    ...
                    <h2 class="title-font mt-2">Phương tiện truyền thông</h2>
                    ...
                    <h2 class="title-font mt-2">Cookies</h2>
                    ...
                    <h2 class="title-font mt-2">Nội dung được nhúng từ các trang web khác</h2>
                    ...
                    <h2 class="title-font mt-2">Chúng tôi chia sẻ dữ liệu của bạn với ai</h2>
                    <p>Nếu bạn yêu cầu đặt lại mật khẩu, địa chỉ IP của bạn sẽ được bao gồm trong email đặt lại.</p>
                    
                    <h2 class="title-font mt-2">Chúng tôi lưu giữ dữ liệu của bạn trong bao lâu</h2>
                    ...
                    <h2 class="title-font mt-2">Bạn có quyền gì đối với dữ liệu của mình</h2>
                    ...
                    <h2 class="title-font mt-2">Nơi chúng tôi gửi dữ liệu của bạn</h2>
