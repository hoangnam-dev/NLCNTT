        ...
        <div class="row">
            <div class="col-md-12">
                <div class="policy-content mt-2">
                    <h2 class="title-font">Bình luận</h2>
                    ...
                    <h2 class="title-font">Phương tiện truyền thông</h2>
                    ...
                    <h2 class="title-font">Cookies</h2>
                    ...
                    <h2 class="title-font">Nội dung được nhúng từ các trang web khác</h2>
                    ...
                    <h2 class="title-font">Chúng tôi chia sẻ dữ liệu của bạn với ai</h2>
                    <p>Nếu bạn yêu cầu đặt lại mật khẩu, địa chỉ IP của bạn sẽ được bao gồm trong email đặt lại.</p>
                    
                    <h2 class="title-font">Chúng tôi lưu giữ dữ liệu của bạn trong bao lâu</h2>
                    ...
                    <h2 class="title-font">Bạn có quyền gì đối với dữ liệu của mình</h2>
                    ...
                    <h2 class="title-font">Nơi chúng tôi gửi dữ liệu của bạn</h2>
