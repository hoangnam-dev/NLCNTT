...
{{-- 
                ...
                <div class="d-flex justify-content-end align-items-start flex-column">
                    {{-- <button class="btn btn-danger btn-lg btn-block mb-3"
                        style="width: 200px" name="default_ord" value="0" type="submit">Đặt hàng
                    </button> --}}
                    ...
                    <button class="btn btn-success btn-lg btn-block"
                        style="width: 200px; background-color: #ad006c;" name="payUrl" value="1" type="submit">Thanh toán MoMo
                    </button>
                    </div>
                </form>
                {{-- <form action="" class="momo-pay">
                    <button class="btn btn-success btn-lg btn-block"
                        style="width: 200px; background-color: #ad006c;" name="payUrl" type="submit">Thanh toán MoMo
                    </button>
                </form> --}}
        </div>
    </div>
