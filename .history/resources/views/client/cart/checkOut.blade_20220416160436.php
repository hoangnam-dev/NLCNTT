            ...
            {{-- <form class="needs-validation" novalidate action="{{ route('client.checkout') }}" method="POST"> --}}
                <form class="needs-validation" novalidate method="POST">
                    ...
                    <div class="d-flex justify-content-end align-items-start flex-column">
                        ...
                        <a href="{{ route('client.checkout.default-pay') }}" class="btn btn-success btn-lg btn-block"
                            style="width: 200px; background-color: #ad006c;" name="payUrl">Đặt hàng
                        </a>
                        <a href="{{ route('client.checkout.momo-payment') }}" class="btn btn-success btn-lg btn-block"
                            style="width: 200px; background-color: #ad006c;" name="payUrl">Thanh toán MoMo
                        </a>
