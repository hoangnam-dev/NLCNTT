    ...
    <div class="container">
        <div class="row">
            ...
            <div class="header-content">
                <p>Đơn hàng (MĐH - <span class="text-span">{{ $orderInfo->madh }}</span>) của bạn đã được xác nhận.</p>
                <p>Đơn hàng sẽ giao tới bạn vào ngày: <span class="text-span">{{ date_format(date_create($orderInfo->ngaygh),'d-m-Y') }}</span>.</p>
        ...
        <div class="row">
            ...
            <div class="order-info mb-2">
                <div>Người đặt hàng: <strong>{{ $orderInfo->tenkh }}</strong></div>
            ...
            <table class="table-fill">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ number_format($item->dongiaban * $item->soluongmua, '0',',','.') }} VNĐ</td>
                    @endforeach
                    <tr>
