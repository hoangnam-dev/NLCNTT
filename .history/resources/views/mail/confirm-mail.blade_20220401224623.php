...
<body>
    <div class="container">
        <div class="row">
            ...
            <div class="header-content">Đơn hàng(Mã đơn hàng - <strong>{{ $orderInfo->madh }}</strong>) của bạn đã được xác nhận và sẽ giao tới bạn vào ngày <strong>{{ date_format(date_create($orderInfo->ngaygh),'d-m-Y') }}</strong>.
            </div>
        </div>
        <hr class="mb-2">
        <div class="row">
