        ...
        <form action="{{ route('admin.users.admin-edit', ['manv'=>$user->manv]) }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <div class="input-group-append">
              <input id="pass" type="password" name="adm_password" class="form-control" placeholder="Nhập mật khẩu..." value="{{ $user->password }}">
          ...
          <div class="form-floating mb-3">
            ...
            <div class="d-flex justify-content-start justify-content-lg-start align-items-center">
              <div class="form-check form-switch mr-4">
                <input class="form-check-input" name="adm_gender" value="Nam" type="checkbox" role="switch" {{ $user->GioiTinh=='Nam'?'checked':'' }}>
                <label class="form-check-label-label" for="flexSwitchCheckDefault">Nam</label>
              </div>
              <div class="form-check form-switch mr-4">
                <input class="form-check-input" name="adm_gender" value="Nữ" type="checkbox" role="switch" {{ $user->GioiTinh=='Nữ'?'checked':'' }}>
                <label class="form-check-label-label" checked for="flexSwitchCheckDefault">Nữ</label>
              </div>
              <div class="form-check form-switch mr-4">
                <input class="form-check-input" name="adm_gender" value="Khác" type="checkbox" role="switch" {{ $user->GioiTinh=='Khác'?'checked':'' }}>
