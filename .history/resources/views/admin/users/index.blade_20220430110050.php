...
<div class="row">
              ...
              <table id="example2" class="table table-bordered table-hover dataTable dtr-inline">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    --}}
                    <button type="button" class="btn btn-primary set-role" data-manv={{ $values->manv }} data-toggle="modal" data-target="#exampleModal">
                      Phân quyền
                    </button>
                    </td>
  ...
  <script>
    ...
    $( ".set-role" ).click(function() {
      ...
      var url = "{{ route('admin.users.admin-set-role') }}";
