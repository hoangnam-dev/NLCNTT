      ...
      <div class="ml-3">
        ...
        <form action="{{ route('admin.users.admin-edit', ['manv'=>$user->manv]) }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <div class="input-group-append">
              <input type="password" name="reenter_pass" class="form-control" placeholder="Nhập lại mật khẩu..." class="passwd">
            </div>
          </div>
          @error('reenter_pass')
          <div class="input-group">
          ...
          <div class="mb-3">
            ...
            <div class="input-group-append">
              <input type="text" name="address" class="form-control" placeholder="Địa chỉ..." class="passwd">
            </div>
          </div>
          <div class="form-floating mb-3">
            ...
            <div class="d-flex justify-content-start justify-content-lg-start align-items-center">
              <div class="form-check form-switch mr-4">
                <input class="form-check-input" name="adm_gender" value="1" type="checkbox" role="switch" {{ $user->gioitinh==1?'checked':'' }}>
                <label class="form-check-label-label" for="flexSwitchCheckDefault">Nam</label>
              </div>
              <div class="form-check form-switch mr-4">
                <input class="form-check-input" name="adm_gender" value="2" type="checkbox" role="switch" {{ $user->gioitinh==2?'checked':'' }}>
                <label class="form-check-label-label" checked for="flexSwitchCheckDefault">Nữ</label>
              </div>
              <div class="form-check form-switch mr-4">
                <input class="form-check-input" name="adm_gender" value="0" type="checkbox" role="switch" {{ $user->gioitinh==0?'checked':'' }}>
