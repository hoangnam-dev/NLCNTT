      ...
      <div class="ml-3">
        ...
        <form action="{{ route('admin.users.admin-edit', ['manv'=>$user->manv]) }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="adm_address" class="form-control" value="{{ $user->diachi }}" placeholder="Địa chỉ...">
          </div>
          @error('adm_address')
          <div class="input-group">
            <p class="text-danger">{{ $message }}</p>
          ...
          <div class="mb-3">
            ...
            <div class="input-group-append">
              <input type="password" name="adm_passwd" autocomplete="off" class="form-control" placeholder="Mật khẩu..." value="{{ old('adm_passwd') }}">
