      ...
      <div class="ml-3">
        ...
        <form action="{{ route('admin.users.admin-create') }}" method="POST">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="adm_address" class="form-control" value="{{ old('adm_address') }}" placeholder="Địa chỉ...">
          </div>
          @error('adm_address')
          <div class="input-group">
            <p class="text-danger">{{ $message }}</p>
          ...
          <div class="form-floating mb-3">
            ...
            <select class="form-control form-select d-block" name="adm_gender">
