  ...
  <div class="row">
    <div class="col-12">
      <div class="ml-3">
        ...
        @endif
        <form action="{{ route('admin.users.admin-create') }}" method="POST" enctype="multipart/form-data">
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="adm_email" class="form-control" value="{{ old('adm_email') }}" placeholder="Nhập Email...">
          </div>
          @error('adm_email')
          <div class="input-group">
            <p class="text-danger">{{ $message }}</p>
          ...
          <div class="mb-3">
            ...
            <div class="input-group-append">
              <input id="pass" type="password" name="adm_password" class="form-control" placeholder="Nhập mật khẩu..." value="{{ old('adm_password') }}">
          ...
          <div class="form-floating mb-3">
            ...
            <div class="d-flex justify-content-start justify-content-lg-start align-items-center">
              <div class="form-check form-switch mr-4">
                <input class="form-check-input" name="adm_gender" value="Nam" type="checkbox" role="switch" checked>
                <label class="form-check-label-label" for="flexSwitchCheckDefault">Nam</label>
              </div>
              <div class="form-check form-switch mr-4">
                <input class="form-check-input" name="adm_gender" value="Nữ" type="checkbox" role="switch">
                <label class="form-check-label-label" checked for="flexSwitchCheckDefault">Nữ</label>
              </div>
              <div class="form-check form-switch mr-4">
                <input class="form-check-input" name="adm_gender" value="Khác" type="checkbox" role="switch">
