                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-check">
                        {{ $values->hasRole($role->tenquyen).' '. $role->tenquyen }}
                        <input class="form-check-input" type="checkbox" value="{{ $role->maquyen }}" {{ $values->hasRole($role->tenquyen) ? 'checked'  : ''}} id="defaultCheck1">
                      </div>
                    </td>
                    @endforeach
