...
$(document).ready(function () {
  // $('.add_attr_modal').on('click', function() { 
  //   var attr_id = $(this).data('attr_id');
  //   $('#add_attr').data('id', attr_id);
  //   alert($(this).data('attr_id'));
  // });
  
  $(document).on("click",".add_attr_modal",function(e){
  ...
  $('#add_attr').on('click', function(event) { 
      ...
      let url = $('#attr_form').data('url');
      let _token = $(this).data('token');
      let attrValue = $('#attr_value').val();
      $('#exampleModal').modal('hide');
      let location = 'create';
      // confirm(attrID +' === '+attrValue);
      $.ajax({
        type: "POST",
        url: url,
        data: {
        ...
        success: function (response) {
          ...
          if (response.status == 'success') {
            ...
            $('#product-attributes').html(response.attributeComponent);
            console.log(response.attributeComponent);
          }
