          ...
          @php
            ...
            <div id="product-attributes">
              ...
              <div class="mb-3">
                ...
                <button type="button" class="btn btn-primary add_attr mb-3" data-toggle="modal" data-target="#exampleModal" data-attr_id="{{ $attr->matt }}" data-whatever="@getbootstrap">Thêm giá trị</button>
              </div>
              @endforeach
            </div>
