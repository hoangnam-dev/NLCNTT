      ...
      <form action="{{ route('admin.products.product-edit', ['masp'=>$product->masp]) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-floating mb-3">
          ...
          <div class="form-check form-switch">
            <input class="form-check-input sell" name="status" value="1" type="checkbox" role="switch" {{ $product->trsngthai==1?'checked':'' }}>
            <label class="form-check-label-label" for="flexSwitchCheckDefault">Có</label>
          </div>
          <div class="form-check form-switch">
            <input class="form-check-input sell" name="status" value="0" type="checkbox" role="switch"  {{ $product->trsngthai==0?'checked':'' }}>
