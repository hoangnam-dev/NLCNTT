    ...
    <div class="ml-3">
      ...
      <form action="{{ route('admin.products.product-edit', ['masp'=>$product->masp]) }}" method="POST"
        ...
        <div class="form-floating mb-3">
          ...
          @php
          $attribute = $product->hasProductDetail;
          @endphp           
          ...
          <hr class="mt-2">
          <div id="other-attributes" class="text-muted mb-2" style="font-size: 18px">Thuộc tính chưa chọn</div>
          @php
            $attribute = $othersAttr
          @endphp
          @include('admin.products.attributes')
          {{-- 
    ...
    $.ajax({
      ...
      success: function (response) {
        if (response.status == 'success') {
          ...
          $('#other-attributes').html(response.attributeComponent);
        }
