...
{{-- {{ dd($listProducts) }} --}}
@section('content')
{{-- <form action="" class="form-inline mb-4 mb-sm-4" role="form">
  <div class="form-group">
    <input type="text" name="key" id="" class="form-control" placeholder="Tìm theo tên"/>
    <button type="submit" id="helpId" class="btn btn-primary"><i class="fa fa-search" aria-hidden="true"></i></button>
  </div>
</form> --}}
