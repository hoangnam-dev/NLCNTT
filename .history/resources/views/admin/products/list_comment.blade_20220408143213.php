    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <a href="{{ route('admin.products.comments') }}" class="btn btn-secondary">Hiển thị đánh giá</a>
                <a href="{{ route('admin.products.reply-comments') }}" class="btn btn-secondary">Hiển thị phản hồi</a>
            </div>
            <div class="card-body">
