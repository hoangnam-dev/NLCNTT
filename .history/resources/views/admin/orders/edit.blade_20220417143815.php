...
<div class="wrap px-3 mb-5">
    ...
    <div class="row">
        <div class="col-md-12x">
            ...
            <button type="submit" name="destroy" class="btn btn-dark my-4" data-toggle="modal"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <textarea name="reason" id="reason" cols="30" rows="10" class="form-control" name="destroy_reason" required></textarea>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Đóng</button>
                                <button type="submit" name="destroy" class="btn btn-primary my-4" data-toggle="modal" data-target="#exampleModal">Xác nhận hủy</button>
                            </div>
                        </div>
                    </form>
