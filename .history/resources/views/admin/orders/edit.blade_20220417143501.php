...
<div class="wrap px-3 mb-5">
                    ...
                    <div class="d-flex justify-content-start align-items-sm-start">
                        ...
                        <div class="mx-3">
                            ...
                            @else
                                ...
                                @endphp
                            @endif
                            <div class="text-center rounded alert-{{ $type }}" style="cursor: default; padding: 0 3px; font-size: 12px">
                                {{ $status }}
                            </div>
                        </div>
                    </div>
                    <div class="addr-delivery_content px-3">
                        <div class="mb-1">Họ tên khách hàng: <span class="text-bold mx-3">{{ $orderInfo->tenkh }}</span></div>
                        <div class="mb-1">Địa chỉ nhận hàng: <span class="text-bold mx-3">{{ $orderInfo->diachi_gh }}</span></div>
                        <div class="mb-1">SĐT khách hàng: <span class="text-bold mx-3">{{ $orderInfo->sodienthoai }}</span></div>
                        <div class="mb-1">Email khách hàng: <span class="text-bold mx-3">{{ $orderInfo->email }}</span></div>
                        ...
                        <div class="mb-3">Ngày giao hàng:
                            ...
                            <span class="text-bold mx-3">{{ date_format(date_create($orderInfo->ngaygh),'d-m-Y')}}</span>
                            @endif
                        </div>
                    </div>
                </div>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="images">
                                <img src="{{ asset('assets/uploads/products').'/'.$item->hasProducts->avatar }}" class="img-fluid"
                                    alt="{{ $item->hasProducts->avatar }}">
                            </div>
                        </td>
    ...
    <div class="row">
        <div class="col-md-12x">
            {{-- <a href="{{ route('admin.orders.order-delete') }}" name="destroy" class="btn btn-dark my-4">Hủy đơn hàng</a> --}}
             <form action="{{ route('admin.orders.order-delete') }}" method="POST">
                ...
                <button type="submit" name="destroy" class="btn btn-dark my-4" data-toggle="modal" data-target="#exampleModal">Hủy đơn hàng</button>
