      ...
      @endif
          <form action="{{ route('admin.promotions.promotion-create') }}" method="POST">
            <div class="mb-3">
              ...
              <input type="text" name="promotion_name" class="form-control" placeholder="Nhập tên khuyến mãi..." value="{{ old('promotion_name') }}">
            ...
            <div class="mb-3">
              ...
              <input type="text" name="promotion_value" class="form-control" placeholder="Nhập giá trị khuyến mãi..." value="{{ old('promotion_value') }}">
            ...
            <div class="mb-3">
              ...
              <input type="datetime-local" name="promotion_begin" class="ml-3" value="{{ old('promotion_begin') }}">
            ...
            <div class="mb-3">
              ...
              <input type="datetime-local" name="promotion_end" class="ml-3" value="{{ old('promotion_end') }}">
              @error('promotion_end')
              <div class="mt-1">
                  <p class="text-danger">{{ $message }}</p>
              </div>
