  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <div class="info d-flex justify-content-start align-items-center">
        <div class="image mr-3" style="padding-left: 0">
          <img src="{{ asset('assets/images/img-user.jpg') }}" class="img-circle elevation-2"
            alt="User Image">
        </div>
        <a href="{{ route('admin.users.admin-edit', ['manv'=>Auth::guard('admin')->user()->tennv]) }}" class="d-block">{{
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="#" class="nav-link">
            <i class="nav-icon fas fa-duotone fa-shield-halved"></i>
            <p>Quyền truy cập<i class="right fas fa-angle-left"></i></p>
          </a>
          <ul class="nav nav-treeview">
            <li class="nav-item">
              {{-- <a href="#" class="nav-link active"> --}}
            ...
            <li class="nav-item">
              {{-- <a href="#" class="nav-link active"> --}}
                <a href="{{ route('admin.roles.role-create') }}" class="nav-link">
                  <i class="nav-icon fas fa-solid fa-square-pen"></i>
                  <p>Thêm quyền</p>
                </a>
            </li>
