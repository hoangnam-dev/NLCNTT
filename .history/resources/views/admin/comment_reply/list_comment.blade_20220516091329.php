...
<div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{-- <form class="ml-3" action="{{ route('admin.users.admin-delete', ['manv'=>$values->manv]) }}"
                                                method="post"> --}}
                                                <form action="{{ route('admin.comments.destroy-comment', ['mabl'=>$values->mabl]) }}" method="GET"></form>
                                                @csrf
                                                {{-- @method('DELETE') --}}
                                                <input type="submit" class="btn btn-danger"  name="comment_del" value="Delete">
    ...
    <script>
        ...
        //     if(confirm( 'Bạn có chắc muốn xóa đánh giá này?' )==true) {
        //         return true;
        //     }
        //     return false;
        // });
