...
<div class="row">
    <div class="col-12">
        <div class="ml-3">
            ...
            <form action="{{ route('admin.comments.edit-reply', ['maph'=>$comment->hasReplyComment->mabl]) }}" method="POST">
                @csrf
                {{-- @method('PUT') --}}
            ...
            <div class="col-2 mb-3">
                <form action="{{ route('admin.comments.destroy-reply', ['mabl'=>$comment->hasReplyComment->mabl]) }}" method="post">
                    @csrf

                    <button type="submit" name="prd_destroy_submit" class="btn btn-danger btn-block">Xóa phản hồi</button>
          ...
          {{-- =====================  --}}
            @else
            <form action="{{ route('admin.comments.comment-detail', ['mabl'=>$comment->mabl]) }}" method="GET">
                @csrf
                {{-- @method('PUT') --}}
