...
Route::prefix('/admin')->group(function () {
    ...
    Route::get('/', [HomeController::class, 'index'])->middleware('checkadminlogin')->name('admin.dashboard');

    Route::middleware('product.permission')->group(function () {

        // Order
        Route::middleware('order.permission')->prefix('/orders')->group(function () {
        ...
        // Products
        Route::middleware('product.permission')->prefix('/products')->group(function () {
            Route::get('/', [ProductsController::class, 'index'])->middleware('product.permission')->name('admin.products');
            ...
            Route::delete('xoa-danh-gia', [CommentsController::class, 'destroyComment'])->name('admin.comments.destroy-comment');
        ...
        Route::middleware('admin.permission')->group(function () {
            ...
            Route::get('/get-location', [AdminController::class, 'getLocation'])->name('admin.getlocation');
